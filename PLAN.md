...
## App Description
A reactive, real-time todo application built with Electric SQL + TanStack DB. Users can create, complete, and delete todos with changes syncing instantly across all connected clients.
